...
public class ClusterMapBuilder extends MapBuilder {
    public static final int SMALL_CLUSTER_RADIUS = Tanker.VIEW_RANGE - 10;
    public static final int OBSERVABLE_CLUSTER_RADIUS = Tanker.VIEW_RANGE;
    public static final int LARGE_CLUSTER_RADIUS = Tanker.VIEW_RANGE + 10;
    ...
    ClusterMapBuilder() {
        ...
        clusterMap.put(LARGE_CLUSTER_RADIUS, new ArrayList<>());
    }
